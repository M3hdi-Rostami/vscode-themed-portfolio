...
function ThemeSelector() {
  ...
  return <div className="absolute top-0 left-0 right-0 mx-auto z-50 select-none p-2 rounded-lg w-xl bg-[var(--sidebar-bg)] text-[var(--text-color)] shadow-[0_20px_40px_rgba(0,0,0,0.25)]">
    ...
    <ul className="text-[var(--text-color)]/60 max-h-[20rem] overflow-y-auto">
